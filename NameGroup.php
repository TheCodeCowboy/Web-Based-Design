		...
		?>
			...
			while ($row = mysqli_fetch_assoc($query_run))
                ...
                <tr class= "gap">
                    <th colspan = "2" ></th>
                    <tr/><tr class = "links">
                    <th colspan= "2"><form action = "changeName.php?group=<?php echo $row['groups'] ?>" method = "POST"><input type="text" name="groupName" placeholder="  Enter  group name" /><button>Submit</button></form>
